...
#### **3. Опыт в DevOps 🐳** 
Настраивала ПО, использовала командную строку Linux, писала на Bash, работала с конфигурационными файлами
- Развернула консольный PostgreSQL, создала базы данных, распределила права пользователей, заполнила БД искуственными данными
- Развернула локальный (и в контейнере) сервер FineBI для визуализации данных из PostgreSQL и создания дашбордов
- Обернула PostgreSQL и FineBI в контейнеры Docker, используя Docker Engine
- Настроила Nginx с Upstream для сетевых взаимодействий между контейнерами
- Написала Bash-скрипты для удобного запуска контейнеров и ПО в них

#### **4. Калькулятор "Быстрица-2" 💾** (HTML, CSS, JS) [есть на GitHub](https://github.com/PlaceboAddict/Bystritsa-2) 
